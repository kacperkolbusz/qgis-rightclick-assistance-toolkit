"""
Change Polygon Layer CRS Action for Right-click Utilities and Shortcuts Hub

Changes the coordinate reference system (CRS) of a polygon layer to a user-selected CRS.
Works on polygon layers and provides a CRS selection dialog.
"""
...
class ChangePolygonLayerCrsAction(BaseAction):
    """Action to change the CRS of a polygon layer."""
    ...
    def __init__(self):
        ...
        # Required properties
        self.action_id = "change_polygon_layer_crs"
        self.name = "Change Polygon Layer CRS"
        self.category = "Layer Operations"
        self.description = "Change the coordinate reference system (CRS) of the selected polygon layer. Transforms all geometries to the new CRS and updates layer metadata."
        self.enabled = True
    ...
    def execute(self, context):
        """
        Execute the change polygon layer CRS action.
...
change_polygon_layer_crs_action = ChangePolygonLayerCrsAction()