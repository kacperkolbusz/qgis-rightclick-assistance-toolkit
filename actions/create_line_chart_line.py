"""
Create Line Chart for Line Layer Action for Right-click Utilities and Shortcuts Hub

Creates a line chart visualization of numeric attributes for line features.
...
class CreateLineChartLineAction(BaseAction):
    """Action to create line charts for line features."""
    ...
    def __init__(self):
        ...
        # Required properties
        self.action_id = "create_line_chart_line"
        self.name = "Create Line Chart"
        self.category = "Analysis"
        self.description = "Create a line chart visualization of numeric attributes for line features. Allows selection of two numeric fields to visualize, displaying trends and relationships over an ordered sequence. Supports exporting charts, visual presets, and customization options."
        self.enabled = True
...
create_line_chart_line_action = CreateLineChartLineAction()
