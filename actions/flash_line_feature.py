"""
Flash Line Feature Action for Right-click Utilities and Shortcuts Hub

Makes the selected line feature flash on the canvas for easy identification.
"""
...
class FlashLineFeatureAction(BaseAction):
    """
    Action to flash the selected line feature on the canvas.
    
    This action makes the clicked line feature flash with a customizable
    ...
    def __init__(self):
        ...
        # Required properties
        self.action_id = "flash_line_feature"
        self.name = "Flash Line Feature"
        self.category = "Visualization"
        self.description = "Make the selected line feature flash on the canvas for easy identification. Customizable flash color, duration, and frequency."
        self.enabled = True
    ...
    def execute(self, context):
        """
        Execute the flash line feature action.
        ...
        try:
            ...
            if show_feature_info:
                self.show_info("Feature Flashing", 
                    f"Line feature ID {feature.id()} is now flashing for {flash_duration} seconds.\n"
                    f"Layer: {layer.name()}\n"
...
flash_line_feature_action = FlashLineFeatureAction()
