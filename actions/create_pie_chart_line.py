"""
Create Pie Chart for Line Layer Action for Right-click Utilities and Shortcuts Hub

Creates a pie chart visualization of attribute values for line features.
...
class PieChartDialog(QDialog):
    ...
    def __init__(self, layer, fields, settings, parent=None):
        ...
        Args:
            ...
            fields: List of numeric field names available for charting
...
class CreatePieChartLineAction(BaseAction):
    """Action to create pie charts for line features."""
    ...
    def __init__(self):
        ...
        # Required properties
        self.action_id = "create_pie_chart_line"
        self.name = "Create Pie Chart"
        self.category = "Analysis"
        self.description = "Create a pie chart visualization of attribute values for line features. Allows selection of any field to visualize, displaying value distribution as proportions. Works with text, numeric, and other field types. Supports exporting charts, visual presets, and customization options."
        self.enabled = True
...
create_pie_chart_line_action = CreatePieChartLineAction()
