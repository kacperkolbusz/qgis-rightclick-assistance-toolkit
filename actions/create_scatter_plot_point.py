"""
Create Scatter Plot for Point Layer Action for Right-click Utilities and Shortcuts Hub

Creates a scatter plot visualization of numeric attributes for point features.
...
class CreateScatterPlotPointAction(BaseAction):
    """Action to create scatter plots for point features."""
    ...
    def __init__(self):
        ...
        # Required properties
        self.action_id = "create_scatter_plot_point"
        self.name = "Create Scatter Plot"
        self.category = "Analysis"
        self.description = "Create a scatter plot visualization of numeric attributes for point features. Allows selection of two numeric fields to visualize, displaying relationships between values. Supports exporting plots, visual presets, and customization options."
        self.enabled = True
...
create_scatter_plot_point_action = CreateScatterPlotPointAction()
