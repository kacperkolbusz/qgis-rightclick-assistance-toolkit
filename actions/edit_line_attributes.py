"""
Edit Line Attributes Action for Right-click Utilities and Shortcuts Hub

Opens an editable window for line features where users can view and modify all attribute values.
...
class EditLineAttributesAction(BaseAction):
    """Action to edit line feature attributes in a dialog window."""
    
    def __init__(self):
        super().__init__()
        
        # Required properties
        self.action_id = "edit_line_attributes"
        self.name = "Edit Line Attributes"
        self.category = "Editing"
        self.description = "Open an editable window to view and modify all attribute values for the selected line feature. Automatically handles edit mode for the layer and saves changes when confirmed."
        self.enabled = True
    ...
    def execute(self, context):
        """Execute the edit line attributes action."""
        # Get settings
...
edit_line_attributes_action = EditLineAttributesAction()
